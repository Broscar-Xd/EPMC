...
<body class="antialiased">
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 align="center" style="color:#000000; font-family: Bebas Neue, cursive;">CONSULTAS</h1>
                <p align="center" style="color:#000000; font-family: Bebas Neue, cursive;">Utiliza nuestros accesos directos para consultar</p>
                <hr>
            </div>
        </div>
        <div class="row">
            <div class="col-6">
                <h3><svg fill="red" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                    </svg> VALORES A CANCELAR SRI</h3>
                <p><a href="https://srienlinea.sri.gob.ec/sri-en-linea/inicio/NAT" class="btn btn-danger"> CONSULTAR </a></p>
            </div>
            <div class="col-6">
                <h3><svg fill="red" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                    </svg> MULTAS Y CITACIONES</h3>
                <p><a href="https://sistemaunico.ant.gob.ec:5038/PortalWEB/paginas/clientes/clp_criterio_consulta.jsp" class="btn btn-danger"> CONSULTAR </a></p>
            </div>
        </div>
        <hr>
        <hr>
        <div class="row">
            <h2 align="center" style="color:#000000; font-family: Bebas Neue, cursive;">CONSULTA TU PLACA</h2>
            <p align="center" style="color:#000000; font-family: Bebas Neue, cursive;">Verifica el estado de tu placa en un solo paso</p>
            <h1 align="center">
                <div class="col">
                    <input class="form-control" type="text" placeholder="PLACA ___-___" aria-label="default input example">
                </div>
                <h1 align="center"><a href="{{route('generadorTurnos')}}" class="btn btn-danger btn-lg">CONSULTAR</a></h1>
            </h1>
        </div>
    </div>
    <br>
