		...
		<div class="row">
			...
			<div class="col-6">
				<div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
					...
					<div class="card-body">
						<h2 class="card-title" align="center" style="color:#FFFFFF; font-family: Bebas Neue, cursive;">Toma tu turno</h2>
						<br><br>
						<div class="d-grid gap-2">
							<h1 align="center" style="color:#FFFFFF; font-family: Bebas Neue, cursive;"><a href="{{route('turnos')}}" class="btn btn-danger btn-lg">AQUÍ</a></h1>
						</div>
					</div>
				</div>
			</div>
			<div class="col-6">
				...
				<div class="card bg-dark text-white">
					<img src="http://epmc.gob.ec/front/img/slider/user_1621527342.jpg" class="card-img" alt="...">
				</div>
			</div>
		</div>
	</div>
