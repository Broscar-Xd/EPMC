            ...
            <div class="col">
                <div class="card bg-dark text-white">
                    ...
                    <div class="card-img-overlay">
                        <h1 class="card-title" align="center" style="color:#f1f1f1">CALENDARIO DE MATRICULACIÓN VEHICULAR</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="site-wrapper content">
        ...
        <section id="breadcrumb">
            <div class="container">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="{{'quienes-somos'}}" title="Institución">Noticias</a></li>
                    <li>CALENDARIO DE MATRICULACIÓN VEHICULAR 2021</li>
                </ul>
        ...
        <section id="about" class="parallax-section-1">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h3 style="color:#FFFFFF" align="center">CALENDARIO DE MATRICULACIÓN VEHICULAR 2021</h3>
                    </div>
                </div>
                <br>
                <div class="row">
                    <h1 align="center">
                        <ul class="blog-post-info">
                            <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar-date" viewBox="0 0 16 16">
                        ...
                        <a href="#"><img class="img-responsive blog-img" src="http://epmc.gob.ec/front/img/news/f_1612280793.jpg" alt="CALENDARIO DE MATRICULACIÓN VEHICULAR 2021"></a>
                    </h1>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col">
                        <p align="center" style="color:#000000">
                            " Para el presente período de matriculación vehicular se aplicará la resolución No 029-DIR-2011-ANT, aprobada por el Directorio de la Institución, en la cual se establece la calendarización para la revisión y matriculación vehicular. Lo que buscamos es disciplinar a los usuarios y así evitar congestionamientos a finales de año recalcó el Ing. Peña.

                            En la Resolución consta el dígito y los meses en los que tendrán que acercarse a matricular su automotor. A diferencia de años anteriores, este año, únicamente podrán matricular su vehículo en el mes que les corresponde, caso contrario deberán hacerlo en el mes de diciembre".
