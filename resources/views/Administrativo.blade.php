...
<head>
	...
	<title>Administrativo | EPMC</title>
		...
		<section id="team">
			<div class="container">
				...
				<div class="col-md-12 text-center wow fadeInUp">
					<h3 class="section-title">Equipo Administrativo</h3>
					<p class="subheading">Conoce a nuestro personal administrativo</p>
				</div>
				...
				<div class="row-centered">
					<div class="col-md-4 col-sm-4 team-member col-centered">
						<div class="effect effects wow fadeInUp">
							<div class="img">
								<img src="http://epmc.gob.ec/team/DANIELA_KAROLYS-min.jpg" class="img-responsive" alt="Daniela Karolys Cobo" />
								<div class="overlay">
									<ul class="expand">
									</ul>
				...
				<div class="row-centered">
					<div class="col-md-4 col-sm-4 team-member col-centered">
						<div class="effect effects wow fadeInUp">
							<div class="img">
								<img src="http://epmc.gob.ec/team/GEOVANA_VAZCO-min.jpg"  class="img-responsive" alt="Geovanna Vasco Amores"/>
								<div class="overlay">
									<ul class="expand">
									</ul>
									<a class="close-overlay hidden">x</a>
					...
					<div class="col-md-4 col-sm-4 team-member col-centered">
						<div class="effect effects wow fadeInUp">
							<div class="img">
								<img src="http://epmc.gob.ec/team/f_1621608866.jpeg" class="img-responsive" alt="Henry Viteri Tigse" />
								<div class="overlay">
									<ul class="expand">
									</ul>
									<a class="close-overlay hidden">x</a>
						...
						<div class="member-info wow fadeInUp">
							<h4>Henry Viteri Tigse</h4>
							<h5 class="highlight"></h5>
							<p>DIRECTOR DE GESTIÓN DE TRÁNSITO</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 team-member col-centered">
						<div class="effect effects wow fadeInUp">
							<div class="img">
								<img src="http://epmc.gob.ec/team/f_1612807606.jpeg" class="img-responsive" alt="Bruno Navia Cedeño" />
								<div class="overlay">
									<ul class="expand">
									</ul>
									<a class="close-overlay hidden">x</a>
						...
						<div class="member-info wow fadeInUp">
							<h4>Bruno Navia Cedeño</h4>
							<h5 class="highlight"></h5>
							<p>PROCURADOR SÍNDICO</p>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 team-member col-centered">
						<div class="effect effects wow fadeInUp">
							<div class="img">
								<img src="http://epmc.gob.ec/team/f_1622044901.jpeg" class="img-responsive" alt="Giovanny Fabricio Dueñas Villacis" />
								<div class="overlay">
									<ul class="expand">
									</ul>
									<a class="close-overlay hidden">x</a>
						...
						<div class="member-info wow fadeInUp">
							<h4>Giovanny Fabricio Dueñas Villacis</h4>
							<h5 class="highlight"></h5>
							<p>DIRECTOR DE GESTIÓN DE TRASPORTE</p>
						</div>
					</div>
				</div>
				<div class="row-centered">
					<div class="col-md-4 col-sm-4 team-member col-centered">
						<div class="effect effects wow fadeInUp">
							<div class="img">
								<img src="http://epmc.gob.ec/team/f_1622149331.jpeg" class="img-responsive" alt="Andrea Braganza Arauz" />
								<div class="overlay">
									<ul class="expand">
									</ul>
									<a class="close-overlay hidden">x</a>
						...
						<div class="member-info wow fadeInUp">
							<h4>Andrea Braganza Arauz</h4>
							<h5 class="highlight"></h5>
							<p>DIRECTORA DE GESTIÓN ADMINISTRATIVA</p>
						</div>
					</div>
				</div>
			</div>
