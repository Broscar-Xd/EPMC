...
<body>
    ...
    <!--    <img src="http://epmc.gob.ec/front/img/backgrounds/bg-shortcodes.jpg" alt="hero"> -->
    <!-- Start Page Top -->
            ...
            <div class="col">
                <div class="card bg-dark text-white">
                    ...
                    <div class="card-img-overlay">
                        <br>
                        <h1 class="card-title" align="center" style="color:aliceblue">NOTICIAS</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div id="masonry">
                    ...
                    <div class="column">
                        <div class="blog-column">
                            <a href="http://epmc.gob.ec/noticia/calendario-de-matriculacion-vehicular-2021"><img class="img-responsive blog-img" src="http://epmc.gob.ec/front/img/news/f_1612280793.jpg" alt=""></a>
                            <div class="column-info">
                                <h4 class="uppercase"><a href="http://epmc.gob.ec/noticia/calendario-de-matriculacion-vehicular-2021">CALENDARIO DE MATRICULACIÓN VEHICULAR 2021</a></h4>
                                ...
                                <p class="text-justify">" Para el presente período de
                                    matriculación vehicular se aplicará la resolución No 029-DIR-2011-ANT,
                                    aprobada por el Directorio de la Institución, en la cual se establece la
                                    calendarizació...</p>
                                <a class="btn btn-primary btn-xs" href="{{route('calendarioMatriculacion')}}">Leer más</a>
                            </div>
                        </div>
                    </div>
                </div>
